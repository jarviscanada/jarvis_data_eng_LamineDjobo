...
public class StockQuoteController {
    ...
    private void buyStock(Scanner scanner) {
        ...
        while (true) {
            ...
            try {
                ...
                // Give the user the option to try again or exit
    ...
    private void sellStock(Scanner scanner) {
        try {
            ...
            logger.error("Error occurred during stock sale: " + e.getMessage(), e);
            System.out.println("An error occurred during the stock sale. Please try again.");
        }
    }
}
